...
* Process the data. The train data and test data are processed separately.
* Merges processed train data set and train data set into a single data set in prepartion for tidying the data.
* Tidy the data set using ''melt'' and ''dcast'' function from reshpae2 package.
